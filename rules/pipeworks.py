...
textures = {
    ...
    '_pipeworks_priority_tube_end': ('gold', 'simple_block_64', 'tube_end'),
    '_pipeworks_priority_tube_inv': ('gold', 'simple_block', 'tube_inv'),
    '_pipeworks_priority_tube_noctr': ('gold', 'simple_block_64', 'tube_noctr'),
    '_pipeworks_priority_tube_plain': ('gold', 'simple_block_64', 'tube_plain'),
    '_pipeworks_priority_tube_plain_right_overlay': ('gold', 'simple_block_64', 'tube_plain_right_overlay'),
    '_pipeworks_priority_tube_short': ('gold', 'simple_block_64', 'tube_short'),
